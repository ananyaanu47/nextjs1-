...
import __NEXT_OPTIMIZE_IMAGES from "next/image"

export default function AboutMe() {
  return (
    <section className="bg-white dark:bg-gray-800">
      <div className="h-48 max-w-6xl mx-auto bg-white dark:bg-gray-800">
        <h1 className="py-20 text-4xl font-bold text-center md:text-8xl md:text-left">
          About Me.
        </h1>
      </div>
        ...
        <div className="grid max-w-6xl grid-cols-1 pt-20 mx-auto md:grid-cols-3 gap-y-20 gap-x-20">
          ...
          <div className="inline-flex flex-col">
            ...
            <div className="mt-8">
              ...
              <p className="mt-4 text-lg text-gray-500 dark:text-gray-300">
                I'm looking for an internship, If you see me as a good fit,
                check my{" "}
                <a
